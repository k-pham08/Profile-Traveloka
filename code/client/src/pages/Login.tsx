...
const NotHaveAccount: FC = () => {
    return <>
        ...
        {/*    <Typography margin={theme.spacing(1)}>Hoặc</Typography>*/}
        {/*</Divider>*/}

        <Typography>Bạn chưa có tài khoản? <Link to={"/register"} style={{color: PRIMARY_COLOR, marginTop: theme.spacing(2)}}>Đăng kí</Link></Typography>
    </>
}
            ...
            <Grid container direction="column" alignItems="center">
                <Grid item xs={1} sm={3} className={classes.loginForm}>
                    ...
                    <TextField
                        ...
                        onChange={(event) => sSignIn.set_username(event.target.value)}
                    />
                    <TextField
                        fullWidth={true}
                        id="password"
                        ...
                        onChange={(event) => sSignIn.set_password(event.target.value)}
                    />
                    <Button
                        fullWidth={true}
                        variant="contained"
