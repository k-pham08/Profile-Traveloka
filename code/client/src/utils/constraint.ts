...
export const SERVICES = [
	{ name: "Vé máy bay", code: "FLIGHT" },
	{ name: "Khách sạn", code: "HOTEL" },
	{ name: "Combo tiết kiệm", code: "SAVING-COMBO" },
	{ name: "Đưa đón sân bay", code: "AIRPORT-PICKLES" },
	{ name: "Cho thuê xe", code: "CAR-RENTAL" },
];
...
export const DRAWER_ITEMS = [
	...
	{ name: "Hợp tác với chúng tôi", link: "/partnership" },
	{ name: "Đã lưu", link: "" },
	{ name: "Đặt chỗ của tôi", link: "" },
];
